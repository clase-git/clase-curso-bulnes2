...
# Función con sintaxis de purrr (Opc 1)
...
# Función con sintaxis de purrr (Opc 2)
nested_walk <- function(v1, v2) {
  walk(v1, function(x) {
    walk(v2, function(y) {
      print(paste(x, y))
    })
...
# Reflexión: no es necesario usar purrr para este tipo de acciones, dado que la
# liberia de purrr esta pensada en automatizar procesos que no son eficientes de
# abarcar con las funciones de R base.
