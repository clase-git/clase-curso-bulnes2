...
### Nombre: Lorena Díaz Gonzalez

#setwd("C:/R_LDIAZ/Lorena_Diaz_Gonzalez/TareaFinal_R")
...
# Llamar script funciones

source(file = "funciones.R", encoding = "utf-8")

# Ejercicio 1: descargar archivos
# 1.1 Encontrar nombres de archivos
...
# Los valores observados en la ESI presentan resultados similares para la mayor parte de los años,salvo para 2020 y 2021.
...
# 4.3. Lista de tablas: calcular promedio con herramientas de purrr, utilizando una función creada que utilice data.table.
...
#El uso de data.table (4ta estrategia) es más eficiente, porque tarda menos en generar resultados y los entrega de manera más ordenada.
